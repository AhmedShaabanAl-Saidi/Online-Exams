...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">online-exams documentation</a>
                </li>
                ...
                <li class="chapter">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? 'id="components-links"' : 'id="xs-components-links"' }>
                            ...
                            <li class="link">
                                <a href="components/MainBtn.html" data-type="entity-link" >MainBtn</a>
                            </li>
                            <li class="link">
                                <a href="components/MainLayout.html" data-type="entity-link" >MainLayout</a>
                            </li>
                            <li class="link">
                                <a href="components/NewPassword.html" data-type="entity-link" >NewPassword</a>
                            </li>
                            <li class="link">
                            ...
                            <li class="link">
                                <a href="components/VerifyOTP.html" data-type="entity-link" >VerifyOTP</a>
                            </li>
                        </ul>
                    </li>
                        <li class="chapter">
